...
<GenerationInfo sourceFile="packages/commandkit/src/components/interactive/select-menu/SelectMenu.ts" sourceLine="154" packageName="commandkit" />
...
<MemberInfo kind="parameter" type={`<a href='/docs/api-reference/commandkit/interfaces/string-select-menu-props#stringselectmenuprops'>StringSelectMenuProps</a>`} />
