...
<GenerationInfo sourceFile="packages/commandkit/src/components/interactive/select-menu/SelectMenu.ts" sourceLine="199" packageName="commandkit" />

The UserSelectMenu component.

```ts title="Signature"
interface UserSelectMenuProps extends
